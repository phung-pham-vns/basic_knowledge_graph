...
if __name__ == "__main__":
    asyncio.run(
        main(
            input_json_path="/Users/mac/Documents/PHUNGPX/knowledge_graph_searching/examples/data/QA_17_pest_disease_predict_with_graphiti_v2.json",
            output_json_path="/Users/mac/Documents/PHUNGPX/knowledge_graph_searching/examples/data/QA_17_pest_disease_predict_with_graphiti_v2.json",
        )
    )
